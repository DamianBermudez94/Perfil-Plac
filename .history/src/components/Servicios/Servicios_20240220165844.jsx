      ...
      {(state) => (
        ...
        >
          <section className="container-servicios" id="servicios">
            <h1>Servicios</h1>
            <article className="content-colocacion">
              ...
              <p>Tus proyectos se vuelven realidad con nuestros servicios expertos en colocación de durlock. ¡Confía en nosotros para transformar tus espacios!</p>
            </article>
