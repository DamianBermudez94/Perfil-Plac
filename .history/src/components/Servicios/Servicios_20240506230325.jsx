...
const Servicios = () => {
  ...
  console.log("soy la lista de las imagenes",imagenes.src);
  ...
  console.log("soy la lista de las imagenes",imagenes.id);
  console.log("soy la lista",listImagenes);
      ...
      <div className="content-colocacion">
        ...
        >
          <div className="container-img">
            <figure>
              <img
                src={imagenes[listImagenes].src}
                alt={imagenes[listImagenes].alt}
              />
            </figure>
          </div>
        </Modal>
