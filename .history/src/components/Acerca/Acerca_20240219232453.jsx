...
const Acerca = () => {
  ...
  return (
    <section className="section-nosotros" id="acerca">
      <div className="container-text__nosotros">
        ...
        <p>
          ...
          altamente calificado combina habilidad técnica con un enfoque centrado
          en el cliente, asegurando resultados excepcionales en cada proyecto.
          Nos comprometemos a superar expectativas y convertir tus ideas en
