    ...
    >
      ...
      <form className="form" action="https://formsubmit.co/bermudezdamian7@gmail.com" method="POST">
        <div className="input-container ic1">
          <input placeholder="" type="text" className="input" name="nombre" id="firstname" />
        ...
        <div className="input-container ic2">
          <input type="text" className="input" name="Apellido" id="lastname" />
          <div className="cut"></div>
        ...
        <div className="input-container ic2">
          <input type="text" className="input" name="subjet" id="asunto" />
          <div className="cut"></div>
